  ...
  return (
    <section className="border-t border-line px-4 py-14 text-center md:px-8">
      ...
      <p className="mx-auto mt-5 max-w-xl text-sm leading-relaxed text-muted">
        {SITE_NAME} chuyên hàng hiệu authentic đã qua kiểm định, cùng những sản phẩm thể thao chính hãng đang giảm
        giá từ các thương hiệu quốc tế hàng đầu — chính hãng 100%, giá tốt hơn nhiều so với giá gốc.
      </p>
